...
const Page = () => {
  ...
  return (
    <div className="md-space-y-0 flex w-full flex-col justify-between space-y-8 md:flex-row">
      <div className="w-full bg-white px-8 py-3 shadow">
          ...
          <span className=" leading-[33px] text-[#333] dark:text-white">
            <div className="w-1/2">
              <SelectGroupOne
                ...
                label={"Filter Applications by date range"}
                name={"interval"}
                onChange={doOnchange}
              />
            </div>
